 ...
 * @author reesadayani
 */
public class Imparfait_Frame extends JFrame implements ActionListener {
...
lblTitle.setText("The Imparfait Tense:");
...
txtIntro.setText("The imparfait (continuous past) emphasises the progression or the regular repetition of an action in the past.");
    add(txtIntro);
...
"**two actions simultaneously occurring action in the past**\n" +
"Example:\t" +
...
txtConstruction.setText("To form the imparfait tense, \nremove the ending from the present-tense verb and add the following endings (identical for verbs of all groups):\n\n"
        + "\nJe\t--ais\tj’aimais\nTu\t--ais\ttu aimais\nIl/Elle\t--ait\til/elle/on aimait\nNous\t--ions\tnous aimions\nVous\t--iez\tvous aimiez\nIls/Elles\t--aient\tils/elles aimaient");
 add(txtConstruction);
